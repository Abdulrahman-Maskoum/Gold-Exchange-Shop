...
class GoldPurchasesScreen extends StatefulWidget {
  const GoldPurchasesScreen({super.key});

  @override
  State<GoldPurchasesScreen> createState() => _GoldPurchasesScreenState();
}

class _GoldPurchasesScreenState extends State<GoldPurchasesScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await firestoreService.goldPurchase(
        uid: uid,
        paidCurrency: _currency,
        goldGrams: grams,
        gramPrice: price,
